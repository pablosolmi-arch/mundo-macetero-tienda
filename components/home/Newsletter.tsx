...
// real list/CRM endpoint exists.
export function Newsletter() {
  const [email, setEmail] = useState("");
  const [ok, setOk] = useState(false);

  return (
    <section className="mm-reveal" style={{ background: "#efe6de", marginTop: "64px", padding: "52px 24px" }}>
      <div style={{ maxWidth: "620px", margin: "0 auto", textAlign: "center" }}>
        ...
        {ok ? (
          ...
          <form
            ...
            style={{ display: "flex", gap: "10px", maxWidth: "440px", margin: "0 auto", flexWrap: "wrap", justifyContent: "center" }}
          >
            <input
              value={email}
